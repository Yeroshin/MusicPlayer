...
public interface ItemTouchHelperAdapter {
    ...
    abstract class RecyclerListAdapter extends RecyclerView.Adapter<RecyclerListAdapter.ViewHolder> implements ItemTouchHelperAdapter {
        ...
        ArrayList<RecyclerListArrayItem> items;
        private int viewType= R.layout.item_playlist;
        private ItemTouchHelperAdapter onLongClickListener;

        public RecyclerListAdapter(Context context,RecyclerView playList) {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v->{
                onLongClickListener.onClick(holder);
            });
        }
        @Override
        ...
        class ItemTouchHelperCallback extends ItemTouchHelper.Callback{
            ...
            /*  @Override
              public void onSelectedChanged(RecyclerListAdapter.ViewHolder viewHolder, int actionState) {
